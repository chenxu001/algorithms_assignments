...
public class Point implements Comparable<Point> {
    ...
    private class SlopeOrder implements Comparator<Point> {
        public int compare(Point p, Point q) {
            ...
            else if (slope1 == Double.NEGATIVE_INFINITY || slope2 == Double.POSITIVE_INFINITY) {
                return -1;
            }
            else if (slope1 == Double.POSITIVE_INFINITY || slope2 == Double.NEGATIVE_INFINITY) {
                return 1;
            }
            else if (Math.abs(slope1 - slope2) < 0.000001) {
                return 0;
            }
    ...
    public static void main(String[] args) {
        /* YOUR CODE HERE */
        Point p = new Point(7453, 14118);
        Point p1 = new Point(13832, 7657);
        Point p2 = new Point(12772, 7657);
        // p1.drawTo(p2);
